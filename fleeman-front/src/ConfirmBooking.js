...
return (
  <Container fluid className="p-0" style={{ backgroundImage: `url("https://media.istockphoto.com/id/1473399467/photo/salesman-showing-cars-to-a-couple-at-the-dealership.jpg?s=2048x2048&w=is&k=20&c=PamTJN0xIL4Na7pWmL1jBKvtqxUjBk_v43-c65-bHoI=")`, backgroundSize: 'cover', minHeight: '100vh' }}>
        <Row className="justify-content-md-center">
